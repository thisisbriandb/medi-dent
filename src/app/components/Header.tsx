...
const Header = ({ sidebarCollapsed }: HeaderProps) => {
  ...
  return (
    <header className={`fixed top-0 right-0 h-16 bg-white/95 backdrop-blur border-b border-gray-200 shadow-sm z-20 transition-all duration-300 ${
      ...
      <div className="flex items-center justify-end h-full px-6">
        <div className="flex items-center gap-3">
          ...
          <button onClick={logout} className="p-2 hover:bg-gray-100 rounded-lg ml-2 transition-colors" title="Se déconnecter">
